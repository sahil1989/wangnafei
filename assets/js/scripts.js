! function(e) {
    ...
    function a() {
        var a = e('input[type="search"], input[type="email"], textarea');
        a.each(function() {
            var a = e(this).val();
    ...
    function l() {
        e(".price-slider").each(function() {
            var a = e(this);
			var formval=$('#fromrange').val();
			var toval=$('#torange').val();
            a.slider({
                min: parseInt(formval),
                max: parseInt(toval),
                step: 5,
                values: [parseInt(formval), parseInt(toval)],
                range: !0,
                slide: function(t, i) {
