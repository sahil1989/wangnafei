		<div class="page-content" style="min-height:294px">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#"><?= $this->lang->line('edit_profile'); ?></a>
					</li>
				</ul>
				...
				<div class="col-md-12">
					...
					<div class="portlet box green-meadow">
						<div class="portlet-title">
							<div class="caption">
								<i class="fa fa-gift"></i><?= $this->lang->line('edit_profile'); ?>
							</div>
							
						</div>
						<div class="portlet-body form">
							<!-- BEGIN FORM-->
							<form action="<?php echo base_url('Adminprofile/updateProfile', get_protocol()); ?>" class="form-horizontal form-bordered" method="post">
								<div class="form-body">
