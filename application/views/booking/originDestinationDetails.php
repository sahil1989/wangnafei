<?php 
    ...
    if ( isset($OriginDestinationOption->FlightSegment) ) {
        ...
        <tr style="display:none">
            ...
            <td>
                <div class="item-body">
                    <div class="item-from" style="text-align:left;">
                    ...
                    <?php if($DepartureAirportDate != $ArrivalAirportDate) { ?>
                        <span style="font-size: 12px; color:#0091EA; border:none;">Overnight Layover</span>
                    <?php } ?>
                    </div>
                    <div class="item-to"  style="text-align:left;">
        ...
        if ( is_array( $FlightSegmentArray ) ) 
        {
            ...
            foreach ( $FlightSegmentArray as $FlightSegmentIndex => $FlightSegment ) 
            {
               ...
               // print_r($FlightSegmentArray);
                ...
                ?>           
                <tr style="margin-top:-1%;" id="connection_flight<?= $cf; ?>">
                    <th>
                        <div class="item-thumb">
                    ...
                    <td colspan="2">
                        <div class="item-body">
                            <div class="item-from" style="width:50%;text-align:left;">
                            ...
                            <div class="item-to" style="width:50%;text-align:left;">
                ...
                <tr class="hd1">
                    <td align="center">Aircraft type: <b><?php echo $EquipmentType; ?></b> </td>
					
                    <td colspan="2">					
						<div>
								<div style="width:47%;margin-left: 5%;float:left">
